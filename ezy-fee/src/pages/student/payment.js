            ...
            >
              ...
              >
                <Box>
                  ...
                  <Typography variant="subtitle2">
                    Mode:{" "}
                    {lastPayment?.mode.charAt(0).toUpperCase() +
                      lastPayment?.mode.slice(1) || "--"}
                  </Typography>
                  <Typography variant="subtitle2">
                    Taken By:{" "}
                    {lastPayment?.taken_by.charAt(0).toUpperCase() +
                      lastPayment?.taken_by.slice(1) || "--"}
                  </Typography>
                </Box>
                <Typography variant="subtitle1" fontWeight="bold" color="error">
                  Dues: ₹
                  {lastDues.due_amount === "--" ? "--" : lastDues.due_amount}
                </Typography>
              </Box>
